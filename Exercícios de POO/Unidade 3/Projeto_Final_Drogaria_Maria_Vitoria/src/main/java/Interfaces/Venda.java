...
public class Venda extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Registro de Vendas");
        ...
        jPanel2Layout.setHorizontalGroup(
                jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(jComboBox1, GroupLayout.PREFERRED_SIZE, 96, GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            int quantidadeDesejada = Integer.parseInt(qtdTexto);
            ...
            for (Medicamento m : lista) {
                if (m.getDescricao().equals(produtoSelecionado)) {
                    medicamentoEscolhido = m;
                    break;
                }
            }

            if (medicamentoEscolhido != null) {
                if (quantidadeDesejada > medicamentoEscolhido.getQuantidadeEstoque()) {
                    JOptionPane.showMessageDialog(null, "Estoque insuficiente! Disponível: " + medicamentoEscolhido.getQuantidadeEstoque());
                    return;
                }

                medicamentoEscolhido.setQuantidade(quantidadeDesejada);
                medicamentoEscolhido.setValorTotal(quantidadeDesejada * medicamentoEscolhido.getValorUnitario());
            ...
            JOptionPane.showMessageDialog(null, "Preencha a quantidade com um número válido.");
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (listaCompra.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Não há itens na lista para finalizar a venda.");
            return;
        }
