...
public class ConexaoBD {
    ...
    // MÉTODO INTELIGENTE: Cadastra cidade, telefone e fornecedor tudo junto de uma vez!
    public void inserirFornecedor(String cnpj, String nome, String telefone, String cidade) {
        try {
            int cidadeId = -1;

            // 1. Verifica se a cidade já existe usando um comando isolado
            ...
            // Se não existir, cadastra a cidade e pega o ID gerado com segurança
            if (cidadeId == -1) {
            ...
            // 2. Cadastra o telefone e pega o código gerado isoladamente
            int telefoneCod = -1;
            ...
            // 3. Cadastra o Fornecedor amarrando os IDs obtidos
    ...
    public void atualizarFornecedor(String cnpj, String nome, String telefone, String cidadeNome) {
        try {
            // 1. Primeiro, descobre qual é o ID do telefone e da cidade associados a este fornecedor
            String sqlBuscaIDs = "SELECT Telefone, Cidade FROM fornecedor WHERE cnpj = ?";
            ...
            if (rs.next()) {
                ...
                idCidade = rs.getInt("Cidade");
            }
            rs.close();
            stmtBusca.close();

            // 2. Atualiza o número na tabela Telefone
            if (idTelefone > 0) {
            ...
            // 3. Atualiza o nome do fornecedor na tabela Fornecedor
            String sqlForn = "UPDATE fornecedor SET nome = ? WHERE cnpj = ?";
            PreparedStatement stmtForn = conexao.prepareStatement(sqlForn);
            stmtForn.setString(1, nome);
            stmtForn.setString(2, cnpj);
            stmtForn.execute();
            stmtForn.close();
    ...
    public ArrayList<Fornecedor> consultarFornecedor(){
        ...
        // Faz um JOIN para trazer o nome da cidade e o número do telefone em vez de mostrar só números
